---
title: "AMNE 170"
subtitle: "Temples, Tombs, and Tyrants: The Archaeology of the Middle East, Greece, and Rome of the Middle East, Greece, and Rome"
author: "Krishaant Pathmanathan, Irene Berezin"
format: revealjs
scrollable: true
fontsize: 200%
theme: serif
...
More than digging and guessing!  

**Notebook 0**: Introduction to AI applications in archaeology  
**Notebook 1**: Zero-shot classification of cuneiform texts  
**Notebook 2**: 
CNNS for Cuneiform 

**Notebook 3**: Regression - predicting age of skeletons from bone data <span style="color: red">(extra!)</span>

**Notebook 4**: Build your own LLM with a document corpus  
...
| Key Application Areas + Case Study (examples of AI)            | 10 min | Visual Walkthrough    |
...
| Satellite mapping       | Object Detection (CNN)        | Finding lost cities in Mesopotamia ()  ![Image source: But, 2024](presentation/images/finding_meso_ai.png){fig-align="center" width="80%"}   |
<!-- 
...
## Key Feature and Results: 
:::{.column width="70%"}
![](presentation/images/bone_regression.png)
:::


Students learn how to apply regression to a real world archaeological dataset to predict age-at-death from bone measurements.
