...
<!-- **Notebook 2**: <span style="color: red">
CNNS for Cuneiform - (Irene) \textcolor{red}{red}</span> -->

**Notebook 2**: Regression - predicting age of skeletons from bone data <span style="color: red">(extra!)</span>

**Notebook 3**: Build your own LLM with a document corpus  
