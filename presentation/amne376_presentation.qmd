...
- We will first create the **image embedding** of this dataset using **[OpenAI CLIP](https://huggingface.co/openai/clip-vit-base-patch32)** base patch model, and cluster the images to see if any interesting patterns are observed. Here we would also introduce the concept of **Bag of Visual Words** that we create based on clustering.
