...
Modern day archeology often involves working with massive repositories of images, geospacial datasets, and textual corpora. Traditional aproaches, while still increadibly valuable, can not only be slow, but sometimes ineffective at revelaing the relationships and patterns archeologists are looking for. Machine learning for archeology helps uncover relationships in archeological data that would be incredibly difficult to spot with the naked eye: from hidden structures under forests to small changes in handwritting in cuneiform scripts. Our aim is hence to show how machine learning tools directly fit into an archeologist's toolbox.
...
- Students will understand the concept behind regression and why its a useul technique in archaeology
...
- Help students understand biasies LLMs have on historical narratives. 
...
- “The Largest Surviving Medical Treatise from Ancient Mesopotamia : History of Information.” Www.historyofinformation.com, www.historyofinformation.com/detail.php?id=2155.

- Kapon, Danielle, et al. “Shaping History: Advanced Machine Learning Techniques for the Analysis and Dating of Cuneiform Tablets over Three Millennia.” ArXiv.org, 2024, arxiv.org/abs/2406.04039. 
